...
```bash
# Publish the views
php artisan vendor:publish --provider="Modules\\Identity\\Providers\\UserServiceProvider" --tag="identity-views"

# (Optional) Publish the config
php artisan vendor:publish --provider="Modules\Identity\Providers\UserServiceProvider" --tag="identity-config"
```
After publishing:
...
ModuForge — Professional Laravel Module Library
